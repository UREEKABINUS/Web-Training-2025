...
export default function resume() {
  return (
    <div className="bg-neutral-700 grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <h1 className="mt-50 text-gray-300 text-4xl font-bold text-center">
        Resume <span className="text-blue-500">Sesi 2</span>
      </h1>
      <p className="text-lg text-gray-300 text-center">
        This is the resume page for Sesi 2. Here you can find information about
